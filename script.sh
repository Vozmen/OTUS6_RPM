...
yum-utils \
gcc
sudo wget https://nginx.org/packages/centos/7/SRPMS/nginx-1.14.1-1.el7_4.ngx.src.rpm -O /root/nginx-1.14.1-1.el7_4.ngx.src.rpm
...
wget https://raw.githubusercontent.com/Vozmen/OTUS6_SOFT/main/nginx.spec -O /root/rpmbuild/SPECS/nginx.spec
...
wget https://raw.githubusercontent.com/Vozmen/OTUS6_SOFT/main/default.conf -O /etc/nginx/conf.d/default.conf
nginx -s reload
